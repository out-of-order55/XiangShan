...
object XDecode extends DecodeConstants {
  val decodeArray: Array[(BitPat, XSDecodeBase)] = Array(
    ...
    // Write special cases first, as they have higher priority.
    CSRs_fflags   -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T),
    CSRs_fcsr     -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T),
    CSRs_vxsat    -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T),
    CSRs_vcsr     -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T),
    CSRs_vstart   -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T),
    CSRs_sstatus  -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T),
    CSRs_vsstatus -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T),
    CSRs_mstatus  -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T),
    CSRs_hstatus  -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T),
    CSRs_mnstatus -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T),
    CSRs_dcsr     -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T),
    CSRs_vtype    -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T),
    CSRs_mireg    -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T, blockBack = T),
    CSRs_sireg    -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T, blockBack = T),
    CSRs_vsireg   -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T, blockBack = T),
    CSRs_mtopi    -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T, blockBack = T),
    CSRs_stopi    -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T, blockBack = T),
    CSRs_vstopi   -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T, blockBack = T),
    CSRs_mtopei   -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T, blockBack = T),
    CSRs_stopei   -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T, blockBack = T),
    CSRs_vstopei  -> XSDecode(SrcType.X, SrcType.imm, SrcType.X, FuType.csr, CSROpType.wrt, SelImm.IMM_Z, xWen = T, noSpec = T, blockBack = T),
